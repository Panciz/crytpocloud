...
public class FileCryptoUtil {
   ...
   public FileCryptoUtil(SecretKey secretKey, String cipher) throws NoSuchPaddingException, NoSuchAlgorithmException, NoSuchProviderException {
        this.secretKey = secretKey;
        this.cipher = Cipher.getInstance(cipher,"BC");
    }
